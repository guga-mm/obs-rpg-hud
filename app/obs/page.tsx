...
export default async function Stats() {
  ...
  const response = await fetch(`http://127.0.0.1:8090/api/collections/hud/records/000000000000000`, {
    method: "GET"
  });
  ...
  return (
    <div>
      <RealTimeStats characters={characters} scene={scene} imageUrl={data.image} color={data.color} />
    </div>
  )
}